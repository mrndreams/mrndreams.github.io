    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-y3ua0i");
    			add_location(img, file, 47, 27, 1203);
    			attr_dev(div3, "id", "viewed-image");
    			attr_dev(div3, "class", "svelte-y3ua0i");
    			add_location(div3, file, 47, 4, 1180);
    			attr_dev(main, "class", "svelte-y3ua0i");
